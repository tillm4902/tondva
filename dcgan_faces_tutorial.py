...
if __name__ == "__main__":
    ...
    **Author**: `Nathan Inkawhich <https://github.com/inkawhich>`__
    ...
    dataroot = "C:\\Users\\Macks\\Desktop\\Homework\\Discord Bot\\3D_FACES\\"
    ...
    try:
        ...
        for img in img_list:
            ...
            plt.savefig("Results\\Generation 6\\epoch{}.png".format(gen), quality = 'figure', bbox_inches = 'tight')
    except:
        print("You did it wrong dumbass.")
